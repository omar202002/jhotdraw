 ...
 *
 * <p>If a connected figure is removed, the connection figure needs to be removed as well. To
 * achieve this, {@code ConnectionFigure} listens to {@code figureRemoved} events sent by the two
 * figures that it connects, and then fires a {@code requestRemove} event to get removed as well.
 *
 * <p>The bezier path of the connection figure can be laid out using a {@link Liner}.
 *
 ...
 * Contract: {@link org.jhotdraw.draw.figure.Figure}, {@link
 * org.jhotdraw.draw.figure.ConnectionFigure}, {@link org.jhotdraw.draw.connector.Connector}, {@link
 ...
 * layout algorithms which are implemented by a liner object.<br>
...
public interface ConnectionFigure extends Figure {
  ...
  /** Gets the start {@code Connector}. Returns null, if there is no start connection. */
  ...
  /**
   * Returns true, if this ConnectionFigure can connect the specified {@code Connector}s. Implement
   * this method to constrain the allowed connections between figures.
   */
  public boolean canConnect(Connector start, Connector end);

  /**
   * Checks if this {@code ConnectionFigure} can be connect to the specified {@code Connector}. This
   * is used to provide an early feedback to the user, when he/she creates a new connection.
   */
  ...
  /**
   * Gets the start figure of the connection. This is a convenience method for doing
   * getStartConnector().getOwner() and handling null cases.
   */
  public Figure getStartFigure();

  /**
   * Gets the end figure of the connection. This is a convenience method for doing
  ...
  /**
   * Get a Liner object which encapsulated a lineout algorithm for this figure. Typically, a Liner
   * accesses the child components of this figure and arranges their graphical presentation.
   *
  ...
  /**
   * Set a Liner object which encapsulated a lineout algorithm for this figure. Typically, a Liner
   * accesses the child components of this figure and arranges their graphical presentation.
   *
  ...
  /**
   * A "lineout" algorithm is used to define how the child components should be laid out in relation
   * to each other. The task for layouting the child components for presentation is delegated to a
   * Liner which can be plugged in at runtime.
   */
  public void lineout();
  // CLONING
  // EVENT HANDLING

...
/**
 * A <em>decorated figure</em> can be decorated with another {@link Figure}, for example to draw a
 * border around the decorated figure.
 *
 ...
 * Component: {@link DecoratedFigure}; Strategy: {@link
...
public interface DecoratedFigure {
   ...
   * decorator is desired. The decorator uses the same logical bounds as this Figure plus
   * AttributeKeys.DECORATOR_INSETS. The decorator does not handle events. The decorator is drawn

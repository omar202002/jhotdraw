...
public interface DOMFactory {
   ...
   * directly.
   *
   * <p>If the object returned by this method is an instanceof {@link DOMStorable} then {@code
   * DOMInput} invokes its read method.
   *
   * @param in The {@code DOMInput} object which creates the object from an element in a DOM.
   */

 ...
 * specified by a prototype. The location of the start and end points are controlled by {@link
 * Connector}s.
 *
...
public class ConnectionTool extends AbstractTool {
  ...
  protected boolean canConnect(
      ConnectionFigure f, Connector startConnector, Connector endConnector) {

...
public interface DOMOutput {
  ...
  /**
   * Adds a new element to the DOM Document and opens it. The new element is added as a child to the
   * current element in the DOM document. Then it becomes the current element. The element must be
   * closed using closeElement.
   */
  ...
  /**
   * Adds an attribute to current element of the DOM Document if it is different from the default
   * value.
   */
  ...
  /**
   * Returns a prototype for the object currently being written. This can be used, to reduce the
   * amount of data written to DOMOutput. For example, by not writing object attributes, which have
   * the same values as the prototype.
   */

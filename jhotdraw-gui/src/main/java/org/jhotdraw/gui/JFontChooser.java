...
public class JFontChooser extends JComponent {
   ...
   *
   * @param newValue The new selected font, or null if no font is to be selected..
   */
  ...
  protected void updateSelectionPath(Font newValue) {
    if (newValue == null
      ...
      if (newValue == null) {
        ...
        if (newFace != null) {
          setSelectionPath(
              new TreePath(new Object[] {getModel().getRoot(), newCollection, newFamily, newFace}));
        } else {
          setSelectionPath(null);
        }
      }

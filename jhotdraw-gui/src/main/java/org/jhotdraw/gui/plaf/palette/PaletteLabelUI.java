...
public class PaletteLabelUI extends BasicLabelUI {
  ...
  protected void installDefaults(JLabel b) {
    ...
    PaletteLookAndFeel.installColorsAndFont(
        b, "Label.background", "Label.foreground", "Label.font");
  ...
  protected void paintEnabledText(JLabel l, Graphics g, String s, int textX, int textY) {
    ...
    if (style != null) {
      if ("emboss".equals(style) && UIManager.getColor("Label.embossForeground") != null) {
        g.setColor(UIManager.getColor("Label.embossForeground"));
        PaletteUtilities.drawString(g, s, mnemIndex, textX, textY + 1);
      } else if ("shadow".equals(style) && UIManager.getColor("Label.shadowForeground") != null) {

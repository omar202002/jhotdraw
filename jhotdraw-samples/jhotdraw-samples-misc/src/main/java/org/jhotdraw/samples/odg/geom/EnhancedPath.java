...
public class EnhancedPath extends ArrayList<EnhancedPath.Segment> implements Shape {
   ...
   */
  public void arcTo(
      Object x1, Object y1, Object x2, Object y2, Object x3, Object y3, Object x4, Object y4) {
    if (size() == 0) {
  ...
  public void quadrantXTo(Object x, Object y) {
    if (size() == 0 || get(size() - 1).type == SegType.CLOSE) {
      throw new IllegalPathStateException(
          "quadrantXTo is only allowed when a path segment is open");
    }
  ...
  public void quadrantYTo(Object x, Object y) {
    if (size() == 0 || get(size() - 1).type == SegType.CLOSE) {
      throw new IllegalPathStateException(
          "quadrantYTo is only allowed when a path segment is open");
    }

...
/**
 * {@code ApplicationModel} provides meta-data for an {@link Application}, actions and factory
 * methods for creating {@link View}s, toolbars and {@link URIChooser}s.
 *
 * <p><hr> <b>Features</b>
 *
 * <p><em>Open last URI on launch</em><br>
 * When the application is started, the last opened URI is opened in a view.<br>
 * {@link #isOpenLastURIOnLaunch()} is used by {@link Application#start} to determine whether this
 * feature is enabled. See {@link org.jhotdraw.api.app} for a list of participating classes.
 *
...
public interface ApplicationModel {
   ...
   *
   * <p>This method is invoked once for the application, and once for each created view.
   *
   * <p>The application adds the created map to a hierarchy of action maps. Thus actions created for
   * the application are accessible from the action maps of the views.
   *
   * @param a Application.
   * @param v The view for which the toolbars need to be created, or null if the actions are to be
   ...
   * Creates tool bars.
   *
   * <p>Depending on the document interface of the application, this method may be invoked only once
   * for the application, or for each opened view.
   *
   * <p>
   *
   * @param a Application.
   * @param v The view for which the toolbars need to be created, or null if the toolbars are shared
   *     by multiple views.
   ...
   *
   * @param a Application.
   * @param v The view for which the chooser needs to be created, or null if the chooser is shared
   *     by multiple views.
  ...
  /**
   * Returns true if the application should open the last opened URI on launch instead of opening an
   * empty view.
   *
   * <p>This method defines an API for the <em>Open last URI on Launch</em> feature. See {@link
   ...
   *
   * <p>This method defines an API for the <em>Allow multiple views for URI</em> feature. See {@link
   * org.jhotdraw.api.app}.
   *

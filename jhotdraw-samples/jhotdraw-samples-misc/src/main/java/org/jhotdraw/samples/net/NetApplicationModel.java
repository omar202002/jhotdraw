...
public class NetApplicationModel extends DefaultApplicationModel {
  ...
  public ActionMap createActionMap(Application a, View v) {
    ...
    m.put(
        "view.toggleGrid", aa = new ToggleViewPropertyAction(a, v, NetView.GRID_VISIBLE_PROPERTY));
  ...
  private void addCreationButtonsTo(JToolBar tb, final DrawingEditor editor) {
    ...
    ButtonFactory.addToolTo(
        tb, editor, new TextCreationTool(new NodeFigure(), attributes), "edit.createNode", labels);
    attributes = new HashMap<AttributeKey<?>, Object>();
    attributes.put(AttributeKeys.STROKE_COLOR, new Color(0x000099));
    ButtonFactory.addToolTo(
        tb,
        editor,
        new ConnectionTool(new LineConnectionFigure(), attributes),
        "edit.createLink",
        labels);
  }

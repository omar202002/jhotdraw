...
public interface Layouter {
  ...
  /**
   * Calculate the layout for the figure and all its subelements. The layout is not actually
   * performed but just its dimensions are calculated.
   *
   ...
   * Implementing classes specify a certain layout algorithm in this method.
   *
   * @param anchor start point for the layout
   * @param lead minimum lead point for the layout
   */

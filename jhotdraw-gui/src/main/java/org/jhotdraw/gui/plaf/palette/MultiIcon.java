...
public abstract class MultiIcon implements Icon {
  ...
  /**
   * The icons from which we choose from. This variable is null, if we are using a tiled image as
   * our base.
   */
  ...
  /**
   * Creates a new instance from an array of icons. All icons must have the same dimensions. If an
   * icon is null, an icon is derived for the state from the other icons.
   */
  ...
  /**
   * Creates a new instance from an array of images. All icons must have the same dimensions. If an
   * icon is null, an icon is derived for the state from the other icons.
   */

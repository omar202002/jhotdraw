...
/**
 * Interface for objects that can be made persistent using <code>DOMOutput.writeObject</code> and
 * <code>DOMInput.readObject</code>.
 *
 * <p>By convention every object implementing the DOMStorable interface MUST provide a public

...
public class CompositeColor extends Color {
   ...
   * with 8-bit precision, so compute from the <code>int</code> color value.
   *
   * @serial
   ...
   *
   * @param compArray an array that this method fills with the color components of this <code>Color
   ...
   * </code> in the <code>ColorSpace</code> specified by the <code>cspace</code> parameter. If
   * <code>compArray</code> is <code>null</code>, an array with length equal to the number of
   * components in <code>cspace</code> is created for the return value. Otherwise, <code>compArray
   * </code> must have at least this length, and it is filled in with the components and returned.
   *
   * @param cspace a specified <code>ColorSpace</code>
   * @param compArray an array that this method fills with the color components of this <code>Color
   *     </code> in the specified <code>ColorSpace</code>
   * @return the color components in a <code>float</code> array.
   */
  @Override

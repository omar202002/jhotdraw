...
public class PaletteLazyActionMap extends ActionMapUIResource {
   ...
   * @param defaultsKey Key to use to defaults table to check for existing map and what resulting
  ...
  private void loadIfNecessary() {
    if (loader != null) {
      ...
      try {
        Method method =
            klass.getDeclaredMethod("loadActionMap", new Class<?>[] {PaletteLazyActionMap.class});

 ...
 *
 * <p>Typically a line decoration is set as an attribute value to a {@link
 * org.jhotdraw.draw.BezierFigure} using the attribute keys {@code
 * org.jhotdraw.draw.AttributeKeys.START_DECORATION} and {@code

...
/**
 * A <em>constrainer</em> constrains editing operations performed by {@link
 * org.jhotdraw.draw.tool.Tool}s and {@link org.jhotdraw.draw.handle.Handle}s on a {@link
 * DrawingView}.
 *
 * <p>{@code Constrainer} objects are associated to {@code DrawingView}'s.
 *
 * <p>Constrainers can draw themselves onto the drawing view to visualize the constraints that they
 * impose. Typically by drawing a grid of some kind.
 *
...
public interface Constrainer {
  ...
  public Point2D.Double translatePoint(
      Point2D.Double p, TranslationDirection dir, Figure... figures);
   ...
   *
   * <p>This method changes the location of the rectangle which is passed as a parameter. This
   * method only performs a translation - it does not change the size of the rectangle.
   *
   * @param r A rectangle on the drawing.
   * @param dir A direction.
   * @return Returns the constrained rectangle.
  ...
  public Rectangle2D.Double translateRectangle(
      Rectangle2D.Double r, TranslationDirection dir, Figure... figures);

  /**
   * Constrains the given angle (in radians). This method changes the angle which is passed as a
   * parameter.
   *
  ...
  /**
   * Moves the given angle (in radians) to the closest constrained orientation in the specified
   * direction.
   *
   * @param angle The angle (in radians).
   * @return The closest constrained angle (in radians) in the specified direction.
   */

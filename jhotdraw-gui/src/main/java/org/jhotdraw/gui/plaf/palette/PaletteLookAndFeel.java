...
public class PaletteLookAndFeel extends BasicLookAndFeel {
  ...
  protected void initComponentDefaults(UIDefaults table) {
    ...
    Object[] defaults = {
      ...
      "Label.border",
          new UIDefaults.ProxyLazyValue(
              "javax.swing.plaf.BorderUIResource$EmptyBorderUIResource", new Object[] {0, 0, 0, 0}),
      // *** Lists
      "List.focusCellHighlightBorder", focusCellHighlightBorder,
      "List.cellRenderer",
          new UIDefaults.ProxyLazyValue("org.jhotdraw.gui.plaf.palette.PaletteListCellRenderer"),
      // *** Panels
      ...
      "Ribbon.border",
          new UIDefaults.ProxyLazyValue(
              ...
              new Object[] {new Insets(1, 0, 0, 0), new Color(0x777777)}),
      // *** ScrollPane
      "ScrollPane.border",
          new UIDefaults.ProxyLazyValue(
              "javax.swing.border.MatteBorder",
              new Object[] {new Insets(1, 1, 1, 1), new Color(0xa5a5a5)}),
      // *** Slider
      ...
      "ToolBar.border",
          new UIDefaults.ProxyLazyValue(
              "org.jhotdraw.gui.plaf.palette.PaletteToolBarBorder$UIResource"), //

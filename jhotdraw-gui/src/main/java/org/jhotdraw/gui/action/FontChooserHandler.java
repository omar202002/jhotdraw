...
public class FontChooserHandler extends AbstractSelectedAction implements PropertyChangeListener {
  ...
  public void actionPerformed(java.awt.event.ActionEvent evt) {
    if ((evt.getActionCommand() == null && JFontChooser.APPROVE_SELECTION == null)
        || (evt.getActionCommand() != null
            && evt.getActionCommand().equals(JFontChooser.APPROVE_SELECTION))) {
      applySelectedFontToFigures();
    } else if ((evt.getActionCommand() == null && JFontChooser.CANCEL_SELECTION == null)
        || (evt.getActionCommand() != null
            && evt.getActionCommand().equals(JFontChooser.CANCEL_SELECTION))) {
    }
    ...
    if (isUpdating++ == 0) {
      if ((evt.getPropertyName() == null && JFontChooser.SELECTED_FONT_PROPERTY == null)
          || (evt.getPropertyName() != null
              && evt.getPropertyName().equals(JFontChooser.SELECTED_FONT_PROPERTY))) {
        applySelectedFontToFigures();
      }
    }
    isUpdating--;

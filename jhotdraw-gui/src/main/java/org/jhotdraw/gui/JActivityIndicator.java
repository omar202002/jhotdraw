...
public class JActivityIndicator extends javax.swing.JPanel {
  ...
  private class Handler implements ActivityManagerListener, PropertyChangeListener {
    ...
    public void propertyChange(PropertyChangeEvent evt) {
      if ((evt.getPropertyName() == null && ActivityModel.INDETERMINATE_PROPERTY == null)
          || (evt.getPropertyName() != null
              && evt.getPropertyName().equals(ActivityModel.INDETERMINATE_PROPERTY))) {
        updateIndeterminate();
      }
      if ((evt.getPropertyName() == null && ActivityModel.NOTE_PROPERTY == null)
          || (evt.getPropertyName() != null
              && evt.getPropertyName().equals(ActivityModel.NOTE_PROPERTY))) {
        updateToolTip();
      }
    }
  }
  ...
  private void updateToolTip() {
    if (models.isEmpty()) {
      ...
      setToolTipText(
          labels.getFormatted("ActivityIndicator.nActivities.toolTipText", models.size()));
    }
  }

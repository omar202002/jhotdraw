...
public class TeddyView extends AbstractView {
  ...
  public void read(URI f, URIChooser chooser) throws IOException {
    ...
    if (chooser == null
      ...
      characterSet =
          ((CharacterSetAccessory) ((JFileURIChooser) chooser).getAccessory()).getCharacterSet();
    }
    read(f, characterSet);
  }
  ...
  public void write(URI f, URIChooser chooser) throws IOException {
    ...
    if (chooser == null
      ...
      characterSet =
          ((CharacterSetAccessory) ((JFileURIChooser) chooser).getAccessory()).getCharacterSet();
      lineSeparator =
          ((CharacterSetAccessory) ((JFileURIChooser) chooser).getAccessory()).getLineSeparator();
    }
  ...
  private Document readDocument(File f, String characterSet) throws IOException {
    ProgressMonitorInputStream pin =
        new ProgressMonitorInputStream(this, "Reading " + f.getName(), new FileInputStream(f));
  ...
  protected StyledDocument createDocument() {
    ...
    doc.setParagraphAttributes(
        0, 1, ((StyledEditorKit) editor.getEditorKit()).getInputAttributes(), true);
    return doc;
  }

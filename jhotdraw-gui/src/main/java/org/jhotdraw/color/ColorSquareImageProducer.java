...
/**
 * Produces a square image for {@link JColorWheel} by interpreting two components of a {@code
 * ColorSpace} as x and y coordinates.
 *
 * @see JColorWheel
  ...
  public void generateColorWheel() {
    ...
    for (int index = 0; index < pixels.length; index++) {
      if (alphas[index] != 0) {
        ...
        pixels[index] =
            (alphas[index] | 0xffffff) & ColorUtil.CStoRGB24(colorSpace, components, rgb);
      }
    }
    newPixels();
    isPixelsValid = true;

...
/**
 * A <em>connector</em> knows how to locate the start point or the end point of a {@link
 * ConnectionFigure} on a connected figure.
 *
 * <p>A connector is created and owned by a {@link Figure}.
 *
 * <p>A connector knows its owning figure. A connector has bounds which describe the area of the
 * figure it is responsible for. A connector can be drawn, so that users can see the bounds of the
 * connector.<br>
 ...
 * Contract: {@link org.jhotdraw.draw.Figure}, {@link ConnectionFigure}, {@link Connector}, {@link
...
public interface Connector extends Cloneable, Serializable {
  ...
  /**
   * Gets the anchor of the connector. This is a point at the center or at the bounds of the figure,
   * where the start or the end point will most likely be attached. The purpose of this method is to
   * give the user a hint, where the connector will most likely be attached to the owner of the
   * connector.
   */

 ...
 *
 * <p>This action is called when the user selects the Cut item in the Edit menu. The menu item is
  ...
  public void actionPerformed(ActionEvent evt) {
    ...
    if (c != null && c.isEnabled()) {
      c.getTransferHandler()
          .exportToClipboard(c, ClipboardUtil.getClipboard(), TransferHandler.MOVE);
    }
  }
}

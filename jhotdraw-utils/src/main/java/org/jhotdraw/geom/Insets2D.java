...
public abstract class Insets2D implements Cloneable, Serializable {
  ...
  /**
   * Checks whether two insets objects are equal. Two instances of <code>Insets2DDouble</code> are
   * equal if the four integer values of the fields <code>top</code>, <code>left</code>, <code>
   * bottom</code>, and <code>right</code> are all equal.
   *
  ...
  /** The <code>Float</code> class defines insets specified in <code>float</code> precision. */
  public static class Float extends Insets2D {
    ...
    /** Constructs and initializes an <code>Insets2D</code> with all insets set to 0. */
    public Float() {}

    /**
     * Constructs and initializes an <code>Insets2D</code> with the specified insets.
     *
     * @param top The top insets.
     * @param left The left insets.
     * @param bottom The bottom insets.
  ...
  /** The <code>Double</code> class defines insets specified in <code>double</code> precision. */
